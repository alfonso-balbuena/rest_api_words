...
class AuthServiceImp(private val repositoryApiKey : IRepositoryApiKey,private val apiService : ApiKeyService) : AuthService {
    ...
    override suspend fun addApiKey(user: String) : ServiceResponse<ApiKeyDB> {
    ...
    override suspend fun validateUserPass(user: String, api: String): ServiceResponse<Boolean> {
